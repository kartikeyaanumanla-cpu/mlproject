...
class DataTransformation:
    ...
    def initiate_data_transformer(self,train_path,test_path):
        try:
            ...
            #trainig input data by droping target_column_name
            ...
            input_feature_test_arr=preprocessing_object.transform(input_feature_test_df)#dont ever train model with  test input
